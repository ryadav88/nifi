...
EPILOGUE_STRING = "In addition, environment variables named 'MYFW_SOME_PARAMETER' " \
                "will be inserted against the provided package myfw (with params of the " \
                " form '{{some-parameter}}')"
...
def main(argv):
    ...
    parser.add_argument('package_dir_path', type=str,
                        help='The local path where the package myfw is located')
